    ...
    <div className="w-full">
      <div className="bg-white w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] flex flex-col items-center justify-between sm:gap-[64px] gap-[37px]">
        ...
        <div className="relative mx-auto my-4">
          ...
          >
            <source src="https://player.vimeo.com/progressive_redirect/playback/1006680121/rendition/1080p/file.mp4?loc=external&signature=665e855c1df1297a68f1ee66e62b4be9ce0f31806e3df2a052039d72c2576d0b" />
