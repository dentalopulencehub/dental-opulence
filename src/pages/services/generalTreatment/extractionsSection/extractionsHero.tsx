...
import extraction_service_hero_image from "../../../../../assets/DO Format/4.jpg"
    ...
    <div className="w-full">
      <div className="bg-[#FFFFFF] rounded-t-[24px] pt-[100px] pb-[100px] h-full w-full items-center flex xl:flex-row flex-col justify-between xl:px-[100px] sm:px-[40px] px-[20px]">
        <div className="flex flex-col xl:items-start items-center w-full xl:w-[50%] py-8">
          ...
          At our dental practice, we understand that the thought of a tooth extraction can be stressful for some patients. That’s why we strive to make the extraction process as comfortable and anxiety-free as possible.          </p>
        ...
        <div className="flex justify-center w-full xl:w-[50%] mt-8 xl:mt-0">
          <Image src={extraction_service_hero_image} alt="Composite Bonding Hero Image" className="max-w-full h-auto" />
        </div>
      </div>
    </div>
  );
...
export default ExtractionsHero;
