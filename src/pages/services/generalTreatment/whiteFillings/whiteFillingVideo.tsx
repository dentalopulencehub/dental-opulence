    ...
    <div className="w-full">
      <div className="bg-white w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] flex flex-col items-center justify-between sm:gap-[64px] gap-[37px]">
        ...
        <div className="relative mx-auto my-4">
          ...
          >
            <source src="https://player.vimeo.com/progressive_redirect/playback/1006679728/rendition/1080p/file.mp4?loc=external&signature=3677ffd86689b89ecccbafcd62e3853dbc3953193aa828cc287ad1fd32f7286b" />
...
export default WhiteFillingVideo;
