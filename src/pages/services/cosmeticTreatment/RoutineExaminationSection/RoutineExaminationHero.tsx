...
const RoutineExaminationHero = () => {
  return (
    <div className="w-full">
      <div className="bg-[#FFFFFF] lg:gap-20  lg:gap-20  rounded-t-[24px] pt-[100px] pb-[100px] h-full w-full items-center flex xl:flex-row flex-col justify-between xl:px-[100px] sm:px-[40px] px-[20px]">
...
export default RoutineExaminationHero;
