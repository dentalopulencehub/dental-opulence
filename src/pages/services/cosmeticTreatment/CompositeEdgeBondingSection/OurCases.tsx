...
import { composite_edge_bonding_images, crown_our_cases_images, home_result_images, invisalign_our_cases_images, theeth_whitening_our_cases_images, white_fillings_our_cases_images } from "../../../../../constants";

type dir = "Left" | "right";

const CompositeEdgeBondingOurCases = () => {
    ...
    <div className="w-full">
      ...
      <div className="mt-6">
        <Carousel direction={direction} setDirection={setDirection}>
          {composite_edge_bonding_images.map((data, index, arr) => (
            <div
...
export default CompositeEdgeBondingOurCases;
