...
const CompositeEdgeBondingVideo = () => {
    ...
    <div className="w-full">
      <div className="bg-white w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] flex flex-col items-center justify-between sm:gap-[64px] gap-[37px]">
        ...
        <div className="relative mx-auto my-4">
          ...
          >
            <source src="https://player.vimeo.com/progressive_redirect/playback/1006677849/rendition/1080p/file.mp4?loc=external&signature=70691702801ea7a1c4e4628a313260627706b75e84747331cc3c2545abf05ab8" />
...
export default CompositeEdgeBondingVideo;
