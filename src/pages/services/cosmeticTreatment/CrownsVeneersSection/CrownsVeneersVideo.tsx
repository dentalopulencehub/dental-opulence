    ...
    <div className="w-full">
      <div className="bg-white w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] flex flex-col items-center justify-between sm:gap-[64px] gap-[37px]">
        ...
        <div className="relative mx-auto my-4">
          ...
          >
            <source src="https://player.vimeo.com/progressive_redirect/playback/1006678134/rendition/1080p/file.mp4?loc=external&signature=b4d453d365a55c659dc71675f25801916628397686d448e3ea2b71012aa81c1c" />
...
export default CrownsVeneersVideo;
