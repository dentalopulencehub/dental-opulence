    ...
    <div className="w-full">
      <div className="bg-white w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] flex flex-col items-center justify-between sm:gap-[64px] gap-[37px]">
        ...
        <div className="relative mx-auto my-4">
          ...
          >
            <source src="https://player.vimeo.com/progressive_redirect/playback/1006678953/rendition/1080p/file.mp4?loc=external&signature=76ce2320865613345d8e6c01ac333f9716a1c689d3c12ff69b43cdbda83f0090" />
...
export default TeethWhiteningVideo;
