  ...
  return (
    <div className="w-full">
      <div className="bg-[#100E10] w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] flex xl:flex-row flex-col justify-between gap-[70px] xl:gap-0">
        <div className="xl:max-w-[600px] md:mx-auto">
          <Image src={home_hero2_ill} alt="" className="mt-10 xl:w-[500px]" />
        </div>
        <div className="xl:max-w-[690px] w-[90%] mx-auto flex flex-col items-center">
          <p className="flex flex-col items-center">
            <span className="text-white font-Pangram-Regular">About us</span>
            <Image src={underline_vector} alt="" />
          </p>
          <h4
            className="text-white font-Pangram-Regular mt-6 sm:text-[25px] text-[20px] sm:leading-[36px] leading-[28px] text-center flex flex-wrap lg:justify-start justify-center"
            ref={element}
          >
