  ...
  return (
    <div className="w-full">
      <div className="w-full lg:px-[100px] sm:px-[40px] px-[20px] pt-[120px] bg-white">
        <div className=" flex-row flex-wrap hidden lg:flex justify-center gap-7 items-center">
          <div className="w-full xl:w-[23%] h-[284px] bg-[#100E10] p-8 rounded-lg flex flex-col justify-between">
            <h3 className="text-white font-inter font-bold text-[32px] leading-[44px]">
        ...
        <div className="lg:hidden grid grid-cols-2 gap-7 ">
          <div className="w-full xl:w-[23%] h-[284px] bg-[#100E10] p-8 rounded-2xl flex flex-col justify-between">
            <h3 className="text-white font-Pangram-Bold lg:text-[32px] text-2xl lg:leading-[44px]">
              Change Your Life With us
            </h3>
            <div className="flex justify-between items-center">
              <Image src={change_life_logo} alt="" />
