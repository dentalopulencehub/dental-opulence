  ...
  return (
    <Link href={href}>
     <div
      ...
      className={`px-4 py-[26px] flex flex-col gap-4 items-start md:h-[267px] h-[300px]  bg-[#222222] border border-[#2D2D2D] rounded-xl max-w-[289px]  service-card`}
     >
        <div className="hidden md:block">        <Image src={hover ? image_inverted : image} alt="" className="" />
      </div>
      <div>
        <h3 className="text-2xl text-[#fff] font-inter font-semibold">{title}</h3>
